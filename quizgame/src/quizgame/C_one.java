...
public class C_one implements ActionListener{
	...
	String[] questions = 	{
								...
								"Lequel est un système d'exploitation utilisé sur l'ordinateur?",
								"Lequel n'est pas un fabricant de l'ordinateur?",
								"RAM est un acronyme pour",
								" DOS' est un acronyme pour",
								"Les composants physiques qui composent un ordinateur sont connues comme:"
							};
	String[][] options = 	{
	...
	public C_one() {
		...
		frameone.setSize(500,700);
		frameone.getContentPane().setBackground(Color.ORANGE);
		...
		frameone.add(time_label);
		frameone.add(seconds_left);
		frameone.add(answer_labelA);
		frameone.add(answer_labelB);
		frameone.add(answer_labelC);
		frameone.add(answer_labelD);
		frameone.add(buttonA);
		frameone.add(buttonB);
		frameone.add(buttonC);
		frameone.add(buttonD);
		frameone.add(textarea);

...
public class C_two implements ActionListener{
	...
	String[] questions = 	{
								...
								"windows 7 est un?",
								"Lequel de ces système d'exploitation est OpenSource?",
								"Lequel de ces logiciels est un logiciel malveillant?",
	...
	public C_two() {
		...
		frametwo.setSize(500,700);
		frametwo.getContentPane().setBackground(Color.ORANGE);
		...
		frametwo.add(time_label);
		frametwo.add(seconds_left);
		frametwo.add(answer_labelA);
		frametwo.add(answer_labelB);
		frametwo.add(answer_labelC);
		frametwo.add(answer_labelD);
		frametwo.add(buttonA);
		frametwo.add(buttonB);
		frametwo.add(buttonC);
		frametwo.add(buttonD);
		frametwo.add(textarea);
		frametwo.add(textfield);

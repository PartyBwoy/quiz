...
public class C_threeEng implements ActionListener{
	...
	JFrame framethreeeng = new JFrame();
	...
	public C_threeEng() {
		framethreeeng.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		framethreeeng.setSize(500,700);
		framethreeeng.getContentPane().setBackground(Color.ORANGE);
		framethreeeng.setLayout(null);
		framethreeeng.setResizable(false);
		...
		framethreeeng.add(time_label);
		framethreeeng.add(seconds_left);
		framethreeeng.add(answer_labelA);
		framethreeeng.add(answer_labelB);
		framethreeeng.add(answer_labelC);
		framethreeeng.add(answer_labelD);
		framethreeeng.add(buttonA);
		framethreeeng.add(buttonB);
		framethreeeng.add(buttonC);
		framethreeeng.add(buttonD);
		framethreeeng.add(textarea);
		framethreeeng.add(textfield);
		framethreeeng.setVisible(true);
...
public void results(){
	...
	percentage.setText(result+"%");
		...
		framethreeeng.add(number_right);
		framethreeeng.add(percentage);
